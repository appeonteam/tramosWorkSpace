...
public function decimal getwrrspd (integer ai_vslid, byte ab_voytype, decimal ad_cons)
end prototypes
...
public function boolean wrrtableexists (integer ai_vslid, byte ab_voytype);
// Function to check if a vessel has any warranted setting for specified voyage type
