...
Else
	...
	If lb_CalcSel = 0 then dw_Calc.Object.t_wrr1.Text = "1) Allowed speed tolerance: ±" + String(ld_DevOSpd, "0.0") + " " + ls_SpdSel Else dw_Calc.Object.t_wrr1.Text = "1) Allowed consumption tolerance: ±" + String(ld_DevWCon, "0.0") + " " + ls_SpdSel
	If li_Percent = 0 then ls_SpdSel = String(ld_DevOSpd, "0.00") + " Knots" Else ls_SpdSel = String(ld_DevOSpd, "0.0") + " %"
	//dw_Calc.Object.t_wrr2.Text = "2) Allowed speed margin: ±" + ls_SpdSel
