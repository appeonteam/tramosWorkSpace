$PBExportHeader$n_axestimationcontrol_bak.sru
$PBExportComments$logic controlling access to estimation(s)
forward
global type n_axestimationcontrol_bak from mt_n_nonvisualobject
end type
end forward

global type n_axestimationcontrol_bak from mt_n_nonvisualobject
end type
global n_axestimationcontrol_bak n_axestimationcontrol_bak
...
on n_axestimationcontrol_bak.create
call super::create
end on

on n_axestimationcontrol_bak.destroy
call super::destroy
end on
