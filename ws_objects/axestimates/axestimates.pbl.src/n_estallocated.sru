$PBExportHeader$n_estallocated.sru
forward
global type n_estallocated from n_estimate
end type
end forward

global type n_estallocated from n_estimate
end type
global n_estallocated n_estallocated
...
on n_estallocated.create
call super::create
end on

on n_estallocated.destroy
call super::destroy
end on
