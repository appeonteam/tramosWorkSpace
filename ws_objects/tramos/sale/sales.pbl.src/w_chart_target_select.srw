$PBExportHeader$w_chart_target_select.srw
$PBExportComments$Associate charterers to a target.
forward
global type w_chart_target_select from w_sale_response
end type
type uo_cross_select from u_cross_select within w_chart_target_select
end type
end forward
...
global w_chart_target_select w_chart_target_select
...
DATE		VERSION 	NAME	DESCRIPTION
-------- 		------- 		----- 		-------------------------------------
16-08-96		1.0	 		KHK		Initial version user with keycodes
...
This.Title = "Charterers for Target" 	//+ ls_keycode_desc
...
on w_chart_target_select.create
int iCurrent
call super::create
...
on w_chart_target_select.destroy
call super::destroy
destroy(this.uo_cross_select)
end on

type st_hidemenubar from w_sale_response`st_hidemenubar within w_chart_target_select
end type
...
lstr_list.dwin_selects = "d_chart_target_list"
...
lstr_list.selects_key_column_name =  "charterers_targets_chart_nr"
lstr_list.selects_key2_column_name = "charterers_targets_ccs_targ__pk"
