$PBExportHeader$w_agent_disbursement.srw
$PBExportComments$Window for editing agents
forward
global type w_agent_disbursement from mt_w_response
end type
type st_notice from statictext within w_agent_disbursement
end type
type cb_2 from commandbutton within w_agent_disbursement
end type
type cb_1 from commandbutton within w_agent_disbursement
end type
type dw_agent from uo_datawindow within w_agent_disbursement
end type
end forward
...
global w_agent_disbursement w_agent_disbursement
...
// If user have access  to change agent for import file set taborder for this field
...
on w_agent_disbursement.create
int iCurrent
call super::create
...
this.Control[iCurrent+4]=this.dw_agent
end on

on w_agent_disbursement.destroy
call super::destroy
...
type st_hidemenubar from mt_w_response`st_hidemenubar within w_agent_disbursement
end type
