$PBExportHeader$w_port.srw
$PBExportComments$Maintainance of port coredata
forward
global type w_port from w_coredata_ancestor
end type
...
type cb_withoutarea from commandbutton within w_port
end type
type cb_1 from commandbutton within w_port
end type
type st_2 from u_topbar_background within w_port
end type
end forward
...
type st_hidemenubar from w_coredata_ancestor`st_hidemenubar within w_port
integer x = 2670
integer y = 32
end type

type uo_searchbox from w_coredata_ancestor`uo_searchbox within w_port
integer x = 18
boolean ib_standard_ui = true
end type

type st_1 from w_coredata_ancestor`st_1 within w_port
integer x = 18
integer y = 16
integer height = 56
integer weight = 400
...
type dw_dddw from w_coredata_ancestor`dw_dddw within w_port
integer x = 18
integer y = 88
integer height = 72
...
type dw_list from w_coredata_ancestor`dw_list within w_port
integer x = 18
integer y = 404
integer height = 1932
integer taborder = 30
...
type cb_close from w_coredata_ancestor`cb_close within w_port
...
type cb_cancel from w_coredata_ancestor`cb_cancel within w_port
integer x = 4224
integer width = 343
integer height = 100
end type
...
type cb_delete from w_coredata_ancestor`cb_delete within w_port
integer x = 3877
integer width = 343
integer height = 100
end type
...
type cb_new from w_coredata_ancestor`cb_new within w_port
integer x = 3182
integer width = 343
integer height = 100
end type
...
type cb_update from w_coredata_ancestor`cb_update within w_port
integer x = 3529
integer width = 343
integer height = 100
end type
...
type st_list from w_coredata_ancestor`st_list within w_port
boolean visible = false
integer x = 18
integer y = 416
integer weight = 400
...
type tab_1 from w_coredata_ancestor`tab_1 within w_port
integer x = 1006
integer y = 240
integer width = 3565
integer height = 2096
...
this.Control[iCurrent+3]=this.tabpage_port_details
this.Control[iCurrent+4]=this.tabpage_details_log
end on
