$PBExportHeader$w_vessel_bak.srw
$PBExportComments$Maintainance of vessel coredata
forward
global type w_vessel_bak from w_coredata_ancestor
end type
...
type cb_modifyvesselnumber from commandbutton within w_vessel_bak
end type
type cb_newbuildings from commandbutton within w_vessel_bak
end type
type uo_pc from u_pc within w_vessel_bak
end type
type st_background from u_topbar_background within w_vessel_bak
end type
end forward
...
global w_vessel_bak w_vessel_bak
...
type st_hidemenubar from w_coredata_ancestor`st_hidemenubar within w_vessel_bak
end type

type uo_searchbox from w_coredata_ancestor`uo_searchbox within w_vessel_bak
integer width = 1051
integer taborder = 10
...
type st_1 from w_coredata_ancestor`st_1 within w_vessel_bak
boolean visible = false
integer y = 332
string text = "Profit Center:"
end type

type dw_dddw from w_coredata_ancestor`dw_dddw within w_vessel_bak
boolean visible = false
integer y = 396
...
type dw_list from w_coredata_ancestor`dw_list within w_vessel_bak
integer y = 496
integer width = 1051
integer height = 1864
integer taborder = 20
...
type cb_close from w_coredata_ancestor`cb_close within w_vessel_bak
boolean visible = false
integer x = 4206
integer y = 2380
integer width = 343
...
type cb_cancel from w_coredata_ancestor`cb_cancel within w_vessel_bak
integer x = 4206
integer y = 2380
integer width = 343
integer height = 100
...
type cb_delete from w_coredata_ancestor`cb_delete within w_vessel_bak
integer x = 3858
integer y = 2380
integer width = 343
integer height = 100
...
type cb_new from w_coredata_ancestor`cb_new within w_vessel_bak
integer x = 3163
integer y = 2380
integer width = 343
integer height = 100
...
type cb_update from w_coredata_ancestor`cb_update within w_vessel_bak
integer x = 3511
integer y = 2380
integer width = 343
integer height = 100
...
type st_list from w_coredata_ancestor`st_list within w_vessel_bak
integer y = 416
integer width = 311
integer weight = 400
...
type tab_1 from w_coredata_ancestor`tab_1 within w_vessel_bak
integer x = 1111
integer y = 240
integer width = 3438
integer height = 2124
