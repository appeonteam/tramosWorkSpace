$PBExportHeader$w_report_tce_laden_ballast.srw
$PBExportComments$TCE Report - (menu: report.tce report)
forward
global type w_report_tce_laden_ballast from window
end type
type cb_close from commandbutton within w_report_tce_laden_ballast
end type
type cb_saveas from commandbutton within w_report_tce_laden_ballast
end type
type cb_print from commandbutton within w_report_tce_laden_ballast
end type
type dw_tce_report from datawindow within w_report_tce_laden_ballast
end type
type dw_vas_report from datawindow within w_report_tce_laden_ballast
end type
type cb_create from commandbutton within w_report_tce_laden_ballast
end type
type dw_select from datawindow within w_report_tce_laden_ballast
end type
type st_2 from statictext within w_report_tce_laden_ballast
end type
type st_1 from statictext within w_report_tce_laden_ballast
end type
type dw_enddate from datawindow within w_report_tce_laden_ballast
end type
type dw_startdate from datawindow within w_report_tce_laden_ballast
end type
type rb_pool from radiobutton within w_report_tce_laden_ballast
end type
type rb_profitcenter from radiobutton within w_report_tce_laden_ballast
end type
type gb_1 from groupbox within w_report_tce_laden_ballast
end type
end forward
...
string title = "TCE Laden-Ballast"
...
global w_report_tce_laden_ballast w_report_tce_laden_ballast
...
on w_report_tce_laden_ballast.create
...
on w_report_tce_laden_ballast.destroy
...
integer taborder = 90
string title = "none"
string dataobject = "d_tce_laden_ballast"
	...
	if dw_vas_report.RowCount() > 0 then
		if (dw_vas_report.getItemDatetime(1, "voyage_startdate") < ldt_start AND &
			...
			// disse rejser skal ikke med
				...
				dw_tce_report.setItem(ll_tce_row, "laden_days", dw_vas_report.getItemNumber(1, "est_act_days_loaded"))			
				dw_tce_report.setItem(ll_tce_row, "ballast_days", dw_vas_report.getItemNumber(1, "est_act_days_ballast"))			
				dw_tce_report.setItem(ll_tce_row, "in_port_days", dw_vas_report.getItemNumber(1, "est_act_days_loading") + dw_vas_report.getItemNumber(1, "est_act_days_discharge") + dw_vas_report.getItemNumber(1, "est_act_days_load_and_disch"))			
				dw_tce_report.setItem(ll_tce_row, "bunkering_days", dw_vas_report.getItemNumber(1, "est_act_days_bunkering"))			
				dw_tce_report.setItem(ll_tce_row, "canal_transit_days", dw_vas_report.getItemNumber(1, "est_act_days_canal"))			
				dw_tce_report.setItem(ll_tce_row, "dry_docking_days", dw_vas_report.getItemNumber(1, "est_act_days_dry_dock"))			
				dw_tce_report.setItem(ll_tce_row, "other_days", dw_vas_report.getItemNumber(1, "est_act_days_other"))			
				dw_tce_report.setItem(ll_tce_row, "idle_days", dw_vas_report.getItemNumber(1, "est_act_days_idle"))			
				dw_tce_report.setItem(ll_tce_row, "off_service_days", dw_vas_report.getItemNumber(1, "est_act_days_off_service"))			
		end if
	end if	
next
dw_tce_report.Sort()
