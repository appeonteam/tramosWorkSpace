$PBExportHeader$u_drag_drop_boxes_gas.sru
$PBExportComments$Used for the selection criterias to the Gas reports in the w_reports_gv window.
forward
global type u_drag_drop_boxes_gas from mt_u_visualobject_calc
end type
type cb_msl from commandbutton within u_drag_drop_boxes_gas
end type
type cb_mal from commandbutton within u_drag_drop_boxes_gas
end type
type cb_msr from commandbutton within u_drag_drop_boxes_gas
end type
type cb_mar from commandbutton within u_drag_drop_boxes_gas
end type
type dw_left from u_dw_multiselect_dragdrop within u_drag_drop_boxes_gas
end type
type dw_right from u_dw_multiselect_dragdrop within u_drag_drop_boxes_gas
end type
type gb_1 from groupbox within u_drag_drop_boxes_gas
end type
end forward
...
global u_drag_drop_boxes_gas u_drag_drop_boxes_gas

type variables
string is_sort_order[] = {"A"}
int ii_sort_column[] = {1}
Boolean ib_enabled = false
Integer ii_left_total
...
public function integer of_enabled ()
end prototypes
...
public function integer of_enabled ();/************************************************************************************
DATE			VER. 	NAME	DESCRIPTION
17-08-2000  1.0	TAU	Initial version. Enable bothe dw_right and dw_left and sets 
								their background colour to white.
************************************************************************************/
If ib_enabled Then
	This.dw_left.Enabled = true
	This.dw_right.Enabled = true
	This.dw_left.Object.DataWindow.Color='16777215'
	This.dw_right.Object.DataWindow.Color='16777215'
	This.cb_msr.Enabled = true
	This.cb_mar.Enabled = true
	This.cb_msl.Enabled = true
	This.cb_mal.Enabled = true
Else
	This.dw_left.Enabled = false
	This.dw_right.Enabled = false
	This.dw_left.Object.DataWindow.Color='12632256'
	This.dw_right.Object.DataWindow.Color='12632256'
	This.cb_msr.Enabled = false
	This.cb_mar.Enabled = false
	This.cb_msl.Enabled = false
	This.cb_mal.Enabled = false
End if

Return 1
end function

event ue_retrieve;call super::ue_retrieve;uf_redraw_off()
...
16_08_00		4.0		TAU	Modifications for use in GAS reports retrieve criteria 
									window.
************************************************************************************/
...
on u_drag_drop_boxes_gas.create
int iCurrent
call super::create
...
on u_drag_drop_boxes_gas.destroy
call super::destroy
destroy(this.cb_msl)
destroy(this.cb_mal)
destroy(this.cb_msr)
...
string dataobject = "d_gas_profit_center"
