$PBExportHeader$w_generate_supervasfile3.srw
$PBExportComments$Window containing the functionality for generating super vasfiles.
forward
global type w_generate_supervasfile3 from window
end type
type hpb_1 from hprogressbar within w_generate_supervasfile3
end type
type em_year from editmask within w_generate_supervasfile3
end type
type st_4 from statictext within w_generate_supervasfile3
end type
type dw_profit_center from datawindow within w_generate_supervasfile3
end type
type cb_3 from commandbutton within w_generate_supervasfile3
end type
type cb_2 from commandbutton within w_generate_supervasfile3
end type
type st_3 from statictext within w_generate_supervasfile3
end type
type st_2 from statictext within w_generate_supervasfile3
end type
type st_1 from statictext within w_generate_supervasfile3
end type
type cb_1 from commandbutton within w_generate_supervasfile3
end type
type gb_1 from groupbox within w_generate_supervasfile3
end type
type dw_vas_log from datawindow within w_generate_supervasfile3
end type
end forward
...
global w_generate_supervasfile3 w_generate_supervasfile3
...
/* Get Filename */
ls_file_name = "VAS3file"+string(today(),"ddmmyy") 
...
on w_generate_supervasfile3.create
...
on w_generate_supervasfile3.destroy
destroy(this.hpb_1)
