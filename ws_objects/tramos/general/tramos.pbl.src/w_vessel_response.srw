$PBExportHeader$w_vessel_response.srw
$PBExportComments$Selection of vessel by number or name response window.
forward
global type w_vessel_response from mt_w_sheet
end type
type uo_vesselselect from u_vessel_selection within w_vessel_response
end type
end forward
...
global w_vessel_response w_vessel_response
...
public subroutine documentation ();/********************************************************************
	...
	<OBJECT>Ancestor object to windows. No longer used for new objects
	</OBJECT>
	<DESC>n/a
	</DESC>
	...
	<HISTORY>
   	Date       	CR-Ref		Author			Comments
	 	00/00/07 	?     		Name Here     	First Version
  		28/10/2010	CR2165		RMO003			This window now inherits from our framework (m_w_sheet)     	
