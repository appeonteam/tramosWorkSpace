$PBExportHeader$n_usersetting.sru
forward
global type n_usersetting from nonvisualobject
end type
end forward

global type n_usersetting from nonvisualobject autoinstantiate
end type
...
on n_usersetting.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_usersetting.destroy
