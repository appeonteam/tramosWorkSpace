$PBExportHeader$mt_w_sheet_calc.srw
$PBExportComments$Standard object for all calculation module windows
forward
global type mt_w_sheet_calc from mt_w_sheet
end type
end forward
...
global mt_w_sheet_calc mt_w_sheet_calc
...
public subroutine documentation ();/********************************************************************
   ...
   <DESC>
	...
	04/04/16		CR4258	AGL027			Removed event ue_consumptionitem()
********************************************************************/
end subroutine

on mt_w_sheet_calc.create
call super::create
end on

on mt_w_sheet_calc.destroy
call super::destroy
end on
...
type st_hidemenubar from mt_w_sheet`st_hidemenubar within mt_w_sheet_calc
end type
