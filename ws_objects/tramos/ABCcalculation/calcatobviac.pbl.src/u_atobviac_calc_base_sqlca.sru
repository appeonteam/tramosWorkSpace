...
global u_atobviac_calc_base_sqlca u_atobviac_calc_base_sqlca

type variables
u_atobviac_calcutil_nvo iuo_calc_nvo   // This object is global for all calculation windows
...
on u_atobviac_calc_base_sqlca.create
call super::create
end on

on u_atobviac_calc_base_sqlca.destroy
call super::destroy
end on
