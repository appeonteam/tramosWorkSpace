$PBExportHeader$w_calc_preview_print.srw
$PBExportComments$The invisible window for printing a calculation
forward
global type w_calc_preview_print from mt_w_sheet_calc
end type
type dw_print from u_datawindow_sqlca within w_calc_preview_print
end type
end forward
...
global w_calc_preview_print w_calc_preview_print
...
on w_calc_preview_print.create
int iCurrent
call super::create
...
on w_calc_preview_print.destroy
call super::destroy
