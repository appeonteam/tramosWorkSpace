$PBExportHeader$w_calc_invisible_print.srw
$PBExportComments$The invisible window for printing a calculation
forward
global type w_calc_invisible_print from mt_w_sheet_calc
end type
type dw_print from u_datawindow_sqlca within w_calc_invisible_print
end type
end forward
...
global w_calc_invisible_print w_calc_invisible_print

event open;call super::open;s_calc_print lstr_calc_print
DataWindowChild dwc_tmp1, dwc_tmp2, dwc_tmp3, dwc_tmp4, dwc_tmp5 

dw_print.DataObject = "d_calc_print"  // For at slå current SetTransObject fra
...
dw_print.GetChild("d_calc_itinerary_print", dwc_tmp4)
...
Close(w_calc_invisible_print)
end event

on w_calc_invisible_print.create
int iCurrent
call super::create
...
on w_calc_invisible_print.destroy
call super::destroy
...
integer width = 439
integer height = 224
string dataobject = "d_calc_print"
end type
