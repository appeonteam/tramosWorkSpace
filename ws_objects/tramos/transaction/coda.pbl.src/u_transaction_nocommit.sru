$PBExportHeader$u_transaction_nocommit.sru
...
forward
global type u_transaction_nocommit from u_transaction
end type
end forward

global type u_transaction_nocommit from u_transaction
end type
global u_transaction_nocommit u_transaction_nocommit
...
on u_transaction_nocommit.create
call super::create
end on

on u_transaction_nocommit.destroy
call super::destroy
end on
