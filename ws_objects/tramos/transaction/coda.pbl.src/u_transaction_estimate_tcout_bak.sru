$PBExportHeader$u_transaction_estimate_tcout_bak.sru
$PBExportComments$tc-out estimation transaction
forward
global type u_transaction_estimate_tcout_bak from u_transaction
end type
end forward

global type u_transaction_estimate_tcout_bak from u_transaction
end type
global u_transaction_estimate_tcout_bak u_transaction_estimate_tcout_bak
...
public function integer of_fill_transaction ();integer 				li_integer
...
on u_transaction_estimate_tcout_bak.create
call super::create
end on

on u_transaction_estimate_tcout_bak.destroy
call super::destroy
end on
