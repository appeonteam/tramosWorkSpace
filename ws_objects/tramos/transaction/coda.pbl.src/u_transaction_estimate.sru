$PBExportHeader$u_transaction_estimate.sru
forward
global type u_transaction_estimate from u_transaction
end type
end forward

global type u_transaction_estimate from u_transaction
end type
global u_transaction_estimate u_transaction_estimate
...
on u_transaction_estimate.create
call super::create
end on

on u_transaction_estimate.destroy
call super::destroy
end on
