$PBExportHeader$w_bunker_purchases_report.srw
$PBExportComments$CR 2195 window copied from (other_reports.pbl) w_hfo_bunker_purchase
forward
global type w_bunker_purchases_report from window
end type
type st_2 from statictext within w_bunker_purchases_report
end type
type st_1 from statictext within w_bunker_purchases_report
end type
type dw_enddate from datawindow within w_bunker_purchases_report
end type
type dw_startdate from datawindow within w_bunker_purchases_report
end type
type dw_profit_center from datawindow within w_bunker_purchases_report
end type
type st_7 from statictext within w_bunker_purchases_report
end type
type cb_saveas from commandbutton within w_bunker_purchases_report
end type
type cb_retrieve from commandbutton within w_bunker_purchases_report
end type
type cb_print from commandbutton within w_bunker_purchases_report
end type
type cb_close from commandbutton within w_bunker_purchases_report
end type
type dw_report from datawindow within w_bunker_purchases_report
end type
end forward
...
global w_bunker_purchases_report w_bunker_purchases_report
...
on w_bunker_purchases_report.create
...
on w_bunker_purchases_report.destroy
destroy(this.st_2)
destroy(this.st_1)
...
/* Retrieve */
//CR2795  Begin modified by JMY014 on 01-06-2012
...
//CR2795 End modified by JMY014 on 01-06-2012
end event
...
integer taborder = 80
string title = "none"
string dataobject = "d_sq_tb_bunker_purchases_report_list"
