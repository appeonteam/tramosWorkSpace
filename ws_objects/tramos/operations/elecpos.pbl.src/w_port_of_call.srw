$PBExportHeader$w_port_of_call.srw
$PBExportComments$Allows opertor to create, delete and modify ports of call.
forward
global type w_port_of_call from w_vessel_basewindow
end type
type gb_nextopenposition from groupbox within w_port_of_call
end type
type gb_2 from groupbox within w_port_of_call
end type
type gb_4 from groupbox within w_port_of_call
end type
type dw_proc_pcnc from u_datagrid within w_port_of_call
end type
type cb_close from commandbutton within w_port_of_call
end type
type cb_poc_list from commandbutton within w_port_of_call
end type
type cb_refresh from commandbutton within w_port_of_call
end type
type rb_all_voyages from radiobutton within w_port_of_call
end type
type rb_only_this_year from radiobutton within w_port_of_call
end type
type gb_1 from groupbox within w_port_of_call
end type
type st_rows from statictext within w_port_of_call
end type
type cb_finished from commandbutton within w_port_of_call
end type
type tab_poc from tab within w_port_of_call
end type
...
type dw_vessel_next_open from mt_u_datawindow within w_port_of_call
end type
type dw_voyage_next_open from mt_u_datawindow within w_port_of_call
end type
type shl_bunker from statichyperlink within w_port_of_call
end type
type st_responsible from statictext within w_port_of_call
end type
type shl_1 from statichyperlink within w_port_of_call
end type
type dw_task_list from mt_u_datawindow within w_port_of_call
end type
type gb_5 from groupbox within w_port_of_call
end type
type st_topbar_background from u_topbar_background within w_port_of_call
end type
type rb_1 from radiobutton within w_port_of_call
end type
type rb_2 from radiobutton within w_port_of_call
end type
type st_date from statictext within w_port_of_call
end type
type st_portarea from statictext within w_port_of_call
end type
type dw_bol_in_poc from u_popupdw within w_port_of_call
end type
type st_warning from statictext within w_port_of_call
end type
type shl_ecovoy from statichyperlink within w_port_of_call
end type
type dw_voyage_alert from u_popupdw within w_port_of_call
end type
type ids_auto_est from mt_n_datastore within w_port_of_call
end type
type ids_auto_act from mt_n_datastore within w_port_of_call
end type
end forward
...
global w_port_of_call w_port_of_call
...
type st_hidemenubar from w_vessel_basewindow`st_hidemenubar within w_port_of_call
end type

type uo_vesselselect from w_vessel_basewindow`uo_vesselselect within w_port_of_call
integer x = 23
integer taborder = 10
end type
...
type ids_auto_est from mt_n_datastore within w_port_of_call descriptor "pb_nvo" = "true" 
event create ( )
event destroy ( )
end type
...
type ids_auto_act from mt_n_datastore within w_port_of_call descriptor "pb_nvo" = "true" 
event create ( )
event destroy ( )
end type
