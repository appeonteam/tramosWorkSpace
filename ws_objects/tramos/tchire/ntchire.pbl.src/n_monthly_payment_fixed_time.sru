$PBExportHeader$n_monthly_payment_fixed_time.sru
$PBExportComments$Monthly Payments fixed time = payday at 00:00
forward
global type n_monthly_payment_fixed_time from n_tc_payment
end type
end forward

global type n_monthly_payment_fixed_time from n_tc_payment
end type
global n_monthly_payment_fixed_time n_monthly_payment_fixed_time
...
on n_monthly_payment_fixed_time.create
call super::create
end on

on n_monthly_payment_fixed_time.destroy
call super::destroy
end on
