$PBExportHeader$u_ntchire_dw.sru
$PBExportComments$Datawindow Control ancestor
forward
global type u_ntchire_dw from mt_u_datawindow
end type
end forward
...
global u_ntchire_dw u_ntchire_dw
...
public subroutine documentation ();/********************************************************************
   ...
   <HISTORY>
   	...
   	02-08-2011 ?            LHC010        		Change the inheritance from the datawindow to mt_u_datawindow 
   </HISTORY>
********************************************************************/

end subroutine

on u_ntchire_dw.create
call super::create
end on

on u_ntchire_dw.destroy
call super::destroy
end on
