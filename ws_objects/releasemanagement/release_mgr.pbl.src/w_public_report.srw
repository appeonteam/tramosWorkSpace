$PBExportHeader$w_public_report.srw
forward
...
public function integer wf_hexasc2decode (ref string as_string);//Converts HEXASCII Encoding string to character string. eg. æ -> 'æ', æææ -> 'æææ'
