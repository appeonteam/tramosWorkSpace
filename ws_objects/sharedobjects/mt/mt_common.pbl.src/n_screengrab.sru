$PBExportHeader$n_screengrab.sru
$PBExportComments$Print screen within Tramos.  Used for error windows to assist support
forward
global type n_screengrab from mt_n_nonvisualobject
end type
type bitmapfileheader from structure within n_screengrab
end type
type bitmapinfoheader from structure within n_screengrab
end type
type bitmapinfo from structure within n_screengrab
end type
end forward
...
global type n_screengrab from mt_n_nonvisualobject autoinstantiate
end type
...
on n_screengrab.create
call super::create
end on

on n_screengrab.destroy
call super::destroy
end on
