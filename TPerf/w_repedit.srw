HA$PBExportHeader$w_repedit.srw
forward
...
if ld_Tmp > 85000 then 
	MessageBox ("Error", "Latitude cannot be higher than 85$$HEX2$$b0002000$$ENDHEX$$N/S.", Exclamation!)
	Return
End If
...
if ld_Tmp > 180000 then 
	MessageBox ("Error", "Longitude cannot be higher than 180$$HEX2$$b0002000$$ENDHEX$$E/W.", Exclamation!)
	Return
End If
ls_Tmp = Right(ls_Tmp,1)
